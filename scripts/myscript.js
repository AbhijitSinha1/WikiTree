...
$(document).ready(function(){
	...
	var histPanel="<div id='bodyContent' class='history' style='cursor:pointer'>History</div><ul  style='list-style-type: none;list-style-image: none;' id='bodyContent' class='histList'></ul><div class='deleteHistory' id='bodyContent' style='cursor:pointer'>Delete History</div>";
	...
	$(".deleteHistory").click(function(){
		var r=confirm("Are you sure you want to delete history?");
		if (r==true){
			localStorage.clear();
			rebuild();
		}
